        ...
        cout << "<div class='card bg-dark text-white' style='border-radius: 1rem;'>" << endl;
         cout <<  "<div class='card-body p-5 text-center'>" << endl;
           ...
           cout<<" <p class='hint-text'>Create your account:</p>";
            ...
            cout<<"<input type='name' class='form-control' name='name' placeholder='Name' required='required'>";
            cout<<"</div>";
            cout <<"<div class='form-group'>";
            cout<<"<input type='email' class='form-control' name='email' placeholder='Email' required='required'>";
            cout<<"</div>";
            cout <<"<div class='form-group'>";
            cout<<"<input type='user' class='form-control' name='user' placeholder='User' required='required'>";
            cout<<"</div>";
            cout <<"<div class='form-group'>";
            cout<<"<input type='user' class='form-control' name='phone_number' placeholder='Phone number' required='required'>";
            cout<<"</div>";
             cout <<"<div class='form-group'>";
            cout<<"<input type='user' class='form-control' name='direction' placeholder='Direction' required='required'>";
            cout<<"</div>";
            cout<<"<div class='form-group'>";
